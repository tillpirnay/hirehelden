      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-[#0A2540] mb-6">
                Unsere Angebotspakete für das Gesundheitswesen
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Wählen Sie das passende Paket für Ihre Personalgewinnung - 
                transparent, fair und erfolgsorientiert.
              </p>
            </div>
            ...
            <div className="text-center mt-12">
              <p className="text-gray-600 mb-6">
                Nicht sicher, welches Paket das richtige für Ihre Gesundheitseinrichtung ist?
              </p>
              <a href="#strategiegespraech" className="bg-[#0A2540] text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-[#0A2540]/90 transition-all duration-300 transform hover:scale-105 shadow-lg inline-block">
