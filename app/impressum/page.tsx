    ...
    <div className="container-section">
      ...
      <div className="space-y-6">
        <section>
          ...
          <p>Kirsty GmbH</p>
          <p>Schanzenstrasse 23</p>
          <p>51063 Köln</p>
        </section>

        <section>
          <h2 className="text-2xl font-bold mb-4">Kontakt</h2>
          <p>Telefon: +49 173 674 2410</p>
          <p>E-Mail: info@hirehelden.de</p>
        </section>
        ...
        <section>
          ...
          <p>Registernummer: HRB 100295</p>
        </section>

        <section>
          <h2 className="text-2xl font-bold mb-4">Vertreten durch</h2>
          <p>Geschäftsführer: Felix Schulze</p>
        </section>

        <section>
          <h2 className="text-2xl font-bold mb-4">Unternehmensgegenstand</h2>
          <p>Die Beratung von Unternehmen zur Optimierung und Digitalisierung des gesamten Employee Lifecycles sowie die Vermittlung von Fach- und Führungskräften.</p>
        </section>

        <section>
          <h2 className="text-2xl font-bold mb-4">Umsatzsteuer-ID</h2>
          <p>Umsatzsteuer-Identifikationsnummer gemäß §27 a Umsatzsteuergesetz: [USt-IdNr einfügen]</p>
        </section>
